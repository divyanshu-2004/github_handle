...
})({"5QRIc":[function(require,module,exports,__globalThis) {
...
document.getElementById("search").onclick = async function() {
    if (document.getElementById("input1").value == "") alert("Plz Enter Your Github Handle");
    else if (arr.some(function(x) {
...
},{"./styles.css":"lW6qc"}],"lW6qc":[function() {},{}]},["5QRIc","aR1JP"], "aR1JP", "parcelRequire94c2")
